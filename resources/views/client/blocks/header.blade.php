                    ...
                    <div>
                      <div class="timer-notification">
                        <h6>
                          ...
                          new offers/gift every signle day on Weekends.<strong
                            class="ms-1"
                ...
                <ul class="about-list right-nav-about">
                  <li class="right-nav-list">
                    <div class="dropdown theme-form-select">
                      ...
                      >
                        <img
                          src="{{ asset('client/assets/images/country/united-states.png"
                      ...
                      >
                        <li>
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/country/united-kingdom.png"
                              class="img-fluid blur-up lazyload"
                              alt=""
                            />
                            <span>English</span>
                        ...
                        <li>
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/country/germany.png"
                              class="img-fluid blur-up lazyload"
                              alt=""
                            />
                            <span>Germany</span>
                        ...
                        <li>
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/country/turkish.png"
                              class="img-fluid blur-up lazyload"
                              alt=""
                            />
                            <span>Turki</span>
              ...
              <div class="col-12">
                <div class="navbar-top">
                  ...
                  <a href="index-2.html" class="web-logo nav-logo">
                    <img
                      src="{{ asset('client/assets/images/logo/1.png"
                      class="img-fluid blur-up lazyload"
                      alt=""
                    />
                  </a>
                        ...
                        <div class="onhover-category-box">
                          <div class="list-1">
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="javascript:void(0)"
                                  >Marie, Health, Digestive</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Cream Biscuits & Wafers</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Glucose & Milk Biscuits</a
                                >
                              </li>
                              <li>
                          ...
                          <div class="list-2">
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="javascript:void(0)"
                                  >Puffs, Patties, Sandwiches</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Breadcrumbs & Croutons</a
                                >
                              </li>
                            </ul>
                          </div>
                        ...
                        <div class="onhover-category-box">
                          <div class="list-1">
                            ...
                            <ul>
                              <li>
                                <a href="javascript:void(0)"
                                  >Lemon, Ginger & Garlic</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Indian & Exotic Herbs</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Vegetables</a
                                >
                              </li>
                              <li>
                          ...
                          <div class="list-2">
                            ...
                            <ul>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Dry Fruits</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Dals & Pulses</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Millet & Flours</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Sugar, Jaggery</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Masalas & Spices</a
                                >
                              </li>
                              <li>
                                <a href="javascript:void(0)"
                                  >Organic Rice, Other Rice</a
                                >
                              </li>
                              <li>
                        ...
                        <ul class="navbar-nav">
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li>
                                <a class="dropdown-item" href="shop-category.html"
                                  >Shop Category Sidebar</a
                                >
                              </li>
                              <li>
                                <a class="dropdown-item" href="shop-banner.html"
                                  >Shop Banner</a
                                >
                              </li>
                              <li>
                          ...
                          <li class="nav-item dropdown dropdown-mega">
                            <a
                              class="nav-link dropdown-toggle ps-xl-2 ps-0"
                              href="javascript:void(0)"
                              data-bs-toggle="dropdown"
                              >Mega Menu</a
                            >
                            ...
                            <ul class="dropdown-menu">
                              <li class="sub-dropdown-hover">
                                ...
                                <ul class="sub-menu">
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/email-templete/abandonment-email.html"
                                      >Abandonment</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/email-templete/offer-template.html"
                                      >Offer Template</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/email-templete/order-success.html"
                                      >Order Success</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/email-templete/reset-password.html"
                                      >Reset Password</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/email-templete/welcome.html"
                                      >Welcome template</a
                                    >
                                  </li>
                                </ul>
                              ...
                              <li class="sub-dropdown-hover">
                                ...
                                <ul class="sub-menu">
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/invoice/invoice-1.html"
                                      >Invoice 1</a
                                    >
                                  </li>
                                  ...
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/invoice/invoice-2.html"
                                      >Invoice 2</a
                                    >
                                  </li>
                                  ...
                                  <li>
                                    <a
                                      href="https://themes.pixelstrap.com/fastkart/invoice/invoice-3.html"
                                      >Invoice 3</a
                                    >
                                  </li>
                                </ul>
