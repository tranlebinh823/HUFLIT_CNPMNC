              ...
              <div class="p-sticky">
                ...
                <div class="ratio_156 section-t-space">
                  <div class="home-contain hover-effect">
                    <img
                      src="{{ asset('client/assets/images/vegetable/banner/8.jpg') }}"
                ...
                <div class="ratio_medium section-t-space">
                  <div class="home-contain hover-effect">
                    <img
                      src="{{ asset('client/assets/images/vegetable/banner/11.jpg') }}"
                    ...
                    <div class="home-detail p-top-left home-p-medium">
                      <div>
                        ...
                        <h2
                          class="text-uppercase fw-normal mb-0 text-russo theme-color"
                        >
                          fresh
                        </h2>
                    ...
                    <ul class="product-list border-0 p-0 d-block">
                      <li>
                        <div class="offer-product">
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/vegetable/product/23.png')}}"
                              class="blur-up lazyload"
                              alt=""
                            />
                          </a>
                      ...
                      <li>
                        <div class="offer-product">
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/vegetable/product/24.png')}}"
                              class="blur-up lazyload"
                              alt=""
                            />
                          </a>
                      ...
                      <li>
                        <div class="offer-product">
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/vegetable/product/25.png')}}"
                              class="blur-up lazyload"
                              alt=""
                            />
                          </a>
                      ...
                      <li class="mb-0">
                        <div class="offer-product">
                          ...
                          >
                            <img
                              src="{{ asset('client/assets/images/vegetable/product/26.png')}}"
                              class="blur-up lazyload"
                              alt=""
                            />
                          </a>
                    ...
                    <div class="review-box">
                      ...
                      <div class="review-profile">
                        <div class="review-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/review/1.jpg') }}"
                            class="img-fluid blur-up lazyload"
                            alt=""
                          />
                        </div>
            ...
            <div class="col-xxl-9 col-xl-8">
                          ...
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/1.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/2.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/3.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            ...
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/4.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/5.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/6.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            ...
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/7.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/8.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/9.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                        ...
                        <div class="col-12 px-0">
                          <div class="product-box">
                            <div class="product-image">
                              <a href="product-left-thumbnail.html">
                                <img
                                  src="{{ asset('client/assets/images/vegetable/product/10.png')}}"
                                  class="img-fluid blur-up lazyload"
                                  alt=""
                                />
                              </a>
                ...
                <div class="row g-md-4 g-3">
                  <div class="col-md-6">
                    <div class="banner-contain hover-effect">
                      <img
                        src="{{ asset('client/assets/images/vegetable/banner/9.jpg') }}"
                        class="bg-img blur-up lazyload"
                        alt=""
                      />
                  ...
                  <div class="col-md-6">
                    <div class="banner-contain hover-effect">
                      <img
                        src="{{ asset('client/assets/images/vegetable/banner/10.jpg') }}"
                        class="bg-img blur-up lazyload"
                        alt=""
                      />
                      <div class="banner-details p-center-left p-4">
              ...
              <div class="section-t-space">
                <div class="banner-contain">
                  <img
                    src="{{ asset('client/assets/images/vegetable/banner/15.jpg') }}"
                    class="bg-img blur-up lazyload"
                    alt=""
                  />
              ...
              <div class="section-t-space section-b-space">
                <div class="row g-md-4 g-3">
                  <div class="col-xxl-8 col-xl-12 col-md-7">
                    <div class="banner-contain hover-effect">
                      <img
                        src="{{ asset('client/assets/images/vegetable/banner/12.jpg') }}"
                        class="bg-img blur-up lazyload"
                        alt=""
                      />
                      <div class="banner-details p-center-left p-4">
                  ...
                  <div class="col-xxl-4 col-xl-12 col-md-5">
                    ...
                    >
                      <img
                        src="{{ asset('client/assets/images/vegetable/banner/13.jpg') }}"
                        class="bg-img blur-up lazyload"
                        alt=""
                      />
                  ...
                  <ul class="product-list">
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/11.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/12.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/13.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/14.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                  ...
                  <ul class="product-list">
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/15.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/16.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/17.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/18.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                  ...
                  <ul class="product-list">
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/19.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/20.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/21.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
                    ...
                    <li>
                      <div class="offer-product">
                        <a href="product-left-thumbnail.html" class="offer-image">
                          <img
                            src="{{ asset('client/assets/images/vegetable/product/22.png')}}"
                            class="blur-up lazyload"
                            alt=""
                          />
                        </a>
              ...
              <div class="section-t-space">
                <div class="banner-contain hover-effect">
                  <img
                    src="{{ asset('client/assets/images/vegetable/banner/14.jpg') }}"
                    class="bg-img blur-up lazyload"
                    alt=""
                  />
                  <div
                  ...
                  <div class="blog-box">
                    <div class="blog-box-image">
                      <a href="blog-detail.html" class="blog-image">
                        <img
                          src="{{ asset('client/assets/images/vegetable/blog/1.jpg') }}"
                          class="bg-img blur-up lazyload"
                          alt=""
                        />
                      </a>
                ...
                <div>
                  <div class="blog-box">
                    <div class="blog-box-image">
                      <a href="blog-detail.html" class="blog-image">
                        <img
                          src="{{ asset('client/assets/images/vegetable/blog/2.jpg') }}"
                          class="bg-img blur-up lazyload"
                          alt=""
                        />
                      </a>
                ...
                <div>
                  <div class="blog-box">
                    <div class="blog-box-image">
                      <a href="blog-detail.html" class="blog-image">
                        <img
                          src="{{ asset('client/assets/images/vegetable/blog/3.jpg') }}"
                          class="bg-img blur-up lazyload"
                          alt=""
                        />
                      </a>
